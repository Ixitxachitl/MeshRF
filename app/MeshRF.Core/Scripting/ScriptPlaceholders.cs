...
public static class ScriptPlaceholders
{
    ...
    [
        ...
        ("rssi",         "Signal level of the triggering packet, as a bare number. A packet radio measures dBm; an SDR measures dBFS, which has no absolute reference. {rssi_unit} says which this one is."),
        ("rssi_unit",    "The unit {rssi} is in for this packet: dBm off a packet radio, dBFS off an SDR, or empty when nothing measured a level."),
