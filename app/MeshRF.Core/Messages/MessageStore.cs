...
/// <see cref="MeshRF.Nodes.NodeStore"/>. Lives at
/// <c>%APPDATA%\MeshRF\messages.db</c>.
/// </summary>
public sealed class MessageStore : IDisposable
{
    ...
    /// identified by its packet id and our own node number. Called when an
    /// ACK/NAK arrives or the ack times out, so the status survives a restart.</summary>
