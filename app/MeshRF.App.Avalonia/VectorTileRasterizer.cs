...
/// time.
///
/// Labels and icons are not drawn here — they need glyph and sprite handling
/// and a collision pass of their own.</summary>
        ...
        VectorTile tile, MapStyle style, int zoom, int x, int y, int sourceMaxZoom, int size)
    {
        ...
        foreach (var layer in style.LayersAt(zoom))
        {
            ...
            switch (layer.Type)
            {
                ...
                // Symbol and raster layers are not drawn in this pass.
                default:
                    break;
            }
        }
